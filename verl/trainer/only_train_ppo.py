...
from verl.trainer.ppo.debug_only_train_ray_trainer import RayPPOTrainer
...
class TaskRunner:
    def run(self, config):
        ...
        from verl.trainer.ppo.debug_only_train_ray_trainer import ResourcePoolManager, Role
